...
$.ui.dialog.prototype.open = function () {
    ...
    var oHeight = parent.outerHeight(),
    ...
    var resize = function () {
        ...
        var absHeight = parent.offset().top,
    	absWidth = parent.offset().right;
        ...
        if (self.options.responsive === true || (self.options.responsive === "touch" && isTouch)) {
            ...
            // check & set height
            if ((absHeight + 100) > wHeight || elem.hasClass("resizedH")) {
                elem.dialog("option", "height", setHeight).parent().css("max-height", setHeight);
                elem.addClass("resizedH");
            }

            // check & set width
            if ((absWidth + 100) > wWidth || elem.hasClass("resizedW")) {
